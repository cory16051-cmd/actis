...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .tl-container, .tl-panel { padding: 8px !important; margin: 0 !important; width: 100% !important; box-sizing: border-box !important; border-radius: 0 !important; border: none !important; box-shadow: none !important; }
        .sticky-top-bar { position: relative !important; top: 0 !important; padding: 0 !important; border: none !important; margin-bottom: 0 !important; }
        /* Ocultar elementos desktop */
        .tl-header { display: none !important; }
        .tl-actions-top { display: none !important; }
        .tl-top-bar { border-bottom: none !important; margin-bottom: 0 !important; padding-bottom: 0 !important; }
        /* Mostrar barras mobile */
        .mob-row1 { display: flex !important; }
        .mob-row2 { display: grid !important; }
        /* Estilos fila 1 */
        .mob-row1 { gap: 6px; width: 100%; margin-bottom: 6px; box-sizing: border-box; }
        .mob-row1 .quick-search { flex: 1 !important; height: 44px !important; font-size: 0.95rem !important; padding: 0 12px !important; border-radius: 10px !important; border: 2px solid #cbd5e1 !important; outline: none !important; box-sizing: border-box !important; min-width: 0 !important; width: auto !important; }
        .mob-row1 .quick-search:focus { border-color: #144973 !important; }
        .mob-btn-sq { width: 44px !important; height: 44px !important; min-width: 44px !important; border: none !important; border-radius: 10px !important; display: flex !important; align-items: center !important; justify-content: center !important; font-size: 1.1rem !important; flex-shrink: 0 !important; cursor: pointer !important; color: white !important; }
        /* Estilos fila 2 */
        .mob-row2 { grid-template-columns: 1fr 1fr !important; gap: 6px !important; width: 100% !important; margin-bottom: 8px !important; box-sizing: border-box !important; }
        .mob-row2 a, .mob-row2 button { display: flex !important; align-items: center !important; justify-content: center !important; gap: 4px !important; padding: 0 6px !important; border-radius: 9px !important; font-size: 0.78rem !important; font-weight: 700 !important; height: 36px !important; white-space: nowrap !important; cursor: pointer !important; text-decoration: none !important; border: none !important; width: 100% !important; box-sizing: border-box !important; }
        /* Estadísticas 4 en fila */
        ...
        div[style*="flex-wrap: wrap; margin-bottom: 20px;"] > div { padding: 6px 4px !important; border-width: 1px !important; border-bottom-width: 3px !important; min-width: 0 !important; }
        div[style*="flex-wrap: wrap; margin-bottom: 20px;"] > div > span:first-child { font-size: 0.58rem !important; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        div[style*="flex-wrap: wrap; margin-bottom: 20px;"] > div > span:last-child { font-size: 1.1rem !important; }
        /* Modal desde abajo */
        .modal-filtros-overlay { align-items: flex-end !important; padding: 0 !important; }
        .modal-filtros-content { max-height: 88vh !important; overflow-y: auto !important; border-radius: 20px 20px 0 0 !important; padding: 16px !important; width: 100% !important; margin: 0 !important; box-sizing: border-box !important; }
        .tl-group[style*="display: flex"] { flex-direction: column !important; gap: 8px !important; }
...
<div class="tl-container">
    <div class="tl-panel">
        ...
        <!-- BARRAS MOBILE: visibles solo en celular vía @media -->
        <div class="mob-row1" style="display:none;">
            <input type="text" id="busqueda_rapida_mob" class="quick-search" 
                   placeholder="Buscar DNI, Nombre o Nro. Turno..." 
                   value="<?= htmlspecialchars($filtro_dni) ?>" 
                   onkeypress="if(event.key==='Enter'){window.location.href='turnos_listar.php?dni='+encodeURIComponent(this.value);}">
            <button type="button" class="mob-btn-sq" style="background:#144973;" 
                    onclick="window.location.href='turnos_listar.php?dni='+encodeURIComponent(document.getElementById('busqueda_rapida_mob').value)">
                <i class="fa-solid fa-magnifying-glass"></i>
            </button>
            <button type="button" class="mob-btn-sq <?= $hay_filtros ? 'active-badge' : '' ?>" 
                    style="background:<?= $hay_filtros ? '#ef4444' : '#3b82f6' ?>;" 
                    onclick="document.getElementById('modalFiltros').classList.add('show')">
                <i class="fa-solid fa-filter"></i>
            </button>
        </div>
        <div class="mob-row2" style="display:none;">
            <?php if ($es_filtro_hoy): ?>
                <a href="turnos_listar.php" style="background:#ef4444;color:white;"><i class="fa-solid fa-xmark"></i>&nbsp;Limpiar Hoy</a>
            <?php else: ?>
                <a href="turnos_listar.php?fecha=<?= $hoy_str ?>" style="background:#10b981;color:white;"><i class="fa-regular fa-calendar-check"></i>&nbsp;Para Hoy</a>
            <?php endif; ?>
            <?php if ($filtro_creado_hoy): ?>
                <a href="turnos_listar.php" style="background:#ef4444;color:white;"><i class="fa-solid fa-xmark"></i>&nbsp;Quitar Sacados</a>
            <?php else: ?>
                <a href="turnos_listar.php?creado_hoy=1" style="background:#8b5cf6;color:white;"><i class="fa-solid fa-clock-rotate-left"></i>&nbsp;Sacados Hoy</a>
            <?php endif; ?>
            <a href="reporte_turnos_pdf.php?dni=<?= urlencode($filtro_dni) ?>" target="_blank" style="background:#eab308;color:white;"><i class="fa-solid fa-file-pdf"></i>&nbsp;PDF</a>
            <?php if(isset($_SESSION['permisos']) && in_array('modulo_turnos_eliminar', $_SESSION['permisos'])): ?>
            <button type="button" onclick="confirmarEliminacionMasiva()" style="background:#ef4444;color:white;"><i class="fa-solid fa-trash-can"></i>&nbsp;Borrar Sel.</button>
            <?php else: ?>
            <a href="turnos_listar.php" style="background:#64748b;color:white;"><i class="fa-solid fa-ban"></i>&nbsp;Limpiar Todo</a>
            <?php endif; ?>
        </div>
