...
} // Fin validacion preview

// Obtener el número recién generado
...
<head>
    <meta charset="UTF-8">
    <title>Imprimiendo Ticket de Asistencia...</title>
    ...
    <style>
        ...
        @media print {
            ...
            * { animation: none !important; filter: none !important; transition: none !important; }
            ...
            .ticket-logo { font-size: 16px; font-weight: 900; margin-bottom: 3px; padding-bottom: 3px; border-bottom: 2px dashed black; }
            .ticket-datos { font-size: 12px; text-align: center; margin-bottom: 10px; font-weight: bold; }
            .ticket-codigo-caja { border: 2px solid black; padding: 5px 0; margin: 10px 0; border-radius: 8px; }
            .ticket-codigo-titulo { font-size: 11px; font-weight: 900; }
            
            /* ESTE ES EL NÚMERO QUE FALTABA IMPRIMIR */
            .ticket-codigo-valor { font-size: 45px; font-weight: 900; letter-spacing: 2px; margin-top: 5px; }
            
                       .ticket-pie { font-size: 12px; font-weight: bold; border-top: 2px dashed black; padding-top: 10px; margin-top: 10px; padding-bottom: 0px; }
        }
    </style>
    <?php if($es_preview): ?>
    <style>
...
<body>
    ...
    <div class="ticket-impresion">
        ...
        <div class="ticket-codigo-caja">
            ...
            <div class="ticket-codigo-valor" style="font-size: 26px;"><?php echo $numero_formateado; ?></div>

            <div class="ticket-codigo-titulo" style="margin-top: 2px; border-top: 1px dashed black; padding-top: 2px;">TOKEN OSFA</div>
            <div class="ticket-codigo-valor"><?php echo $token; ?></div>
        </div>
