...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: reporte_ventanilla.php?".$_POST['query_string']); exit;
}
...
// Lógica de separación: Si NO estamos uniendo, filtramos SOLO los de Ventanilla (NO tienen número de orden)
if ($ver_unidos !== 1) { 
    $where_clauses[] = "(numero_orden IS NULL OR numero_orden = '')"; 
}
    ...
    <div class="header-filtros">
        ...
        <div style="display:flex; flex-direction:column; gap:10px; width:100%;">
            <div class="botones-arriba">
                ...
                <a href="reporte_ventanilla_pdf.php?<?php echo $query_string_pdf; ?>" target="_blank" class="btn-action bg-success"><i class="fa-solid fa-file-pdf"></i> PDF</a>
